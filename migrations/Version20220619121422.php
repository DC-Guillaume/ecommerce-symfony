 ...
 */
final class Version20220619121422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_details ADD CONSTRAINT FK_845CA2C1A15A2E17 FOREIGN KEY (customer_order_id) REFERENCES `order` (id) ON DELETE CASCADE');
    }
